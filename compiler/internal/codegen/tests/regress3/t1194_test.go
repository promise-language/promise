...
func TestT1194IncDecBorrowParamGuardsFlag(t *testing.T) {
	ir := codegentest.GenerateIR(t, t1194Counter+`
		bump(Counter c) { c++; }
		main() {}
	`)
	codegentest.AssertContains(t, ir, "store i1 false, i1* %c.dropflag")
	codegentest.AssertContains(t, ir, "incdec.flagdrop")
}
...
func TestT1194PlainAssignBorrowParamRegistersDrop(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, "store i1 false, i1* %c.dropflag")
	codegentest.AssertContains(t, ir, "call void @Counter.drop")
}
...
func TestT1194GenericBorrowParamRegistersDrop(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, "store i1 false, i1* %b.dropflag")
}
