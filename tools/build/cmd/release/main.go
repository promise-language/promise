...
//	bin/release cut next   [--dry-run] [--reason <text>] [--sha <commit/ref>] [--run-ci] [--no-ci-wait] [--notes-file <path>|-] [--notes <text>]
//	bin/release cut stable [--dry-run] [--reason <text>] [--sha <commit/ref>] [--run-ci] [--no-ci-wait] [--confirm-year] [--notes-file <path>|-] [--notes <text>]
//	bin/release ci [platform...] [--no-tests] [--watch] [--ref <branch>] [--commit-hash <sha>] [--force]
//
