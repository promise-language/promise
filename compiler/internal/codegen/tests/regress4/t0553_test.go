...
func TestT0553_ModuleUserDropAutoAppendsFieldDrops(t *testing.T) {
	...
	body := codegentest.ExtractPlainDefinition(ir, "__mod_modlib__T0553ModBase.drop")
	if body == "" {
...
func TestT0553_ModuleUserDropNonEmptyBodyAutoAppends(t *testing.T) {
	...
	body := codegentest.ExtractPlainDefinition(ir, "__mod_modlib__T0553ModBaseBody.drop")
	if body == "" {
