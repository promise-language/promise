...
func TestWasmImportAttributes(t *testing.T) {
	ir := codegentest.GenerateIRForTarget(t, `
		...
		main() {}
	`, "wasm32-wasi")
	codegentest.AssertContains(t, ir, `"wasm-import-module"="wasi_snapshot_preview1"`)
	codegentest.AssertContains(t, ir, `"wasm-import-name"="fd_write"`)
	// WASM imports use direct return and params for primitives (not sret/i8*)
	codegentest.AssertContains(t, ir, "declare i64 @fd_write(i64 %fd)")
}
...
func TestWallclockAndMonotonicShareOneClockImport(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "call i32 @clock_time_get(i32 1,")
}
...
func TestCrossModuleValueTypeParamLayout(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "define i64 @Foo.bar(i8* %this, %promise_Duration_v %d)")
}
...
func TestWasmImportIgnoredOnNative(t *testing.T) {
	...
	ir := codegentest.GenerateIR(t, `
		...
		main() {}
	`)
	codegentest.AssertNotContains(t, ir, "wasm-import-module")
}
...
func TestWasmExternWithoutImportStillSret(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "declare void @test_internal(i8* %sret, i8* %x)")
}
...
func TestUseVarDeclFailableInitAutoPropagate(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "call { i1, { i8*, i8* }, i8* } @Res.make(")
	...
	// `use` slot %r.
	codegentest.AssertContains(t, ir, "{ i8*, i8* }* %r")
}
...
func TestUseBoundBothCloseAndDropSuppressesUserDrop(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "call { i1, i8* } @Conn.close(")
	// The heap instance is reclaimed via pal_free on the close-free path.
	codegentest.AssertContains(t, ir, "close.free")
	...
	mainIR := codegentest.ExtractFunc(ir, "main")
	if mainIR == "" {
		t.Fatal("could not extract main function from IR")
	}
	codegentest.AssertNotContains(t, mainIR, "call void @Conn.drop(")
}
...
func TestT0340_ModuleGenericFuncMutRefArgClearsDropFlag(t *testing.T) {
	ir := codegentest.GenerateIRWithModule(t, "mylib",
...
func TestClosureModuleQualifiedCallResultTracked(t *testing.T) {
	ir := codegentest.GenerateIRWithModule(t, "cblib",
	...
	codegentest.AssertContains(t, codegentest.ExtractFunction(ir, "__user.discard_fresh"), "env.tmp.drop")
}

func TestHostTargetTripleInModule(t *testing.T) {
	ir := codegentest.GenerateIR(t, `main() {}`)
	triple := codegen.HostTargetTriple()
	codegentest.AssertContains(t, ir, "target triple = \""+triple+"\"")
}
...
func TestModuleCallQualified(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "define i64 @__mod_mylib_compute")
	// Call should use the mangled name
	codegentest.AssertContains(t, ir, "call i64 @__mod_mylib_compute")
}
...
func TestModuleCallDoesNotCollideWithUser(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "define i64 @__user.compute")
	codegentest.AssertContains(t, ir, "define i64 @__mod_mylib_compute")
...
func TestModuleTypeConstructor(t *testing.T) {
	ir := codegentest.GenerateIRWithModule(t, "geo",
	...
	codegentest.AssertContains(t, ir, "Point")
...
func TestModuleMethodCall(t *testing.T) {
	ir := codegentest.GenerateIRWithModule(t, "counter",
		`type Counter `+"`public"+` {
			int value;
	...
	codegentest.AssertContains(t, ir, "define i64 @__mod_counter_Counter.get_value")
	// Call should use the module-prefixed method
	codegentest.AssertContains(t, ir, "call i64 @__mod_counter_Counter.get_value")
}

func TestModuleGlobImportCall(t *testing.T) {
	ir := codegentest.GenerateIRWithModule(t, "helpers",
	...
	codegentest.AssertContains(t, ir, "define i64 @__mod_helpers_greet")
	codegentest.AssertContains(t, ir, "call i64 @__mod_helpers_greet")
}

func TestModuleFuncWithParams(t *testing.T) {
	ir := codegentest.GenerateIRWithModule(t, "math",
	...
	codegentest.AssertContains(t, ir, "define i64 @__mod_math_add(i64 %a, i64 %b)")
	codegentest.AssertContains(t, ir, "call i64 @__mod_math_add(i64 3, i64 4)")
}

func TestModuleVoidFunc(t *testing.T) {
	ir := codegentest.GenerateIRWithModule(t, "logger",
		"noop() `public {}",
		`
		use logger "./logger";
		main() {
	...
	codegentest.AssertContains(t, ir, "define void @__mod_logger_noop()")
	codegentest.AssertContains(t, ir, "call void @__mod_logger_noop()")
}

func TestModuleFailableFunc(t *testing.T) {
	ir := codegentest.GenerateIRWithModule(t, "parser",
		`
	...
	codegentest.AssertContains(t, ir, "define { i1, i64, i8* } @__mod_parser_parse(i64 %x)")
	codegentest.AssertContains(t, ir, "call { i1, i64, i8* } @__mod_parser_parse(i64 10)")
}

func TestModuleExternFunc(t *testing.T) {
	ir := codegentest.GenerateIRWithModule(t, "ffi",
		`
	...
	codegentest.AssertContains(t, ir, "declare void @test_cfunc")
	// Wrapper should be a module function
	codegentest.AssertContains(t, ir, "define i64 @__mod_ffi_wrapper")
}

func TestModuleEnumVariant(t *testing.T) {
	ir := codegentest.GenerateIRWithModule(t, "shapes",
		`
		enum Shape `+"`public"+` {
			Circle(int radius),
			Rect(int w, int h),
	...
	codegentest.AssertContains(t, ir, "Shape")
...
func TestModuleGlobImportType(t *testing.T) {
	ir := codegentest.GenerateIRWithModule(t, "models",
		`
		type Item `+"`public"+` {
			int id;
	...
	codegentest.AssertContains(t, ir, "define i64 @__mod_models_Item.get_id")
	codegentest.AssertContains(t, ir, "call i64 @__mod_models_Item.get_id")
	// Constructor stores the field value
	codegentest.AssertContains(t, ir, "store i64 7")
}

func TestModuleGlobImportMultipleSymbols(t *testing.T) {
	ir := codegentest.GenerateIRWithModule(t, "utils",
		`
	...
	codegentest.AssertContains(t, ir, "define i64 @__mod_utils_foo")
	codegentest.AssertContains(t, ir, "define i64 @__mod_utils_bar")
	codegentest.AssertContains(t, ir, "call i64 @__mod_utils_foo()")
	codegentest.AssertContains(t, ir, "call i64 @__mod_utils_bar()")
}
...
func TestMultipleModules(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "define i64 @__mod_alpha_get_a")
	codegentest.AssertContains(t, ir, "define i64 @__mod_beta_get_b")
	codegentest.AssertContains(t, ir, "call i64 @__mod_alpha_get_a")
	codegentest.AssertContains(t, ir, "call i64 @__mod_beta_get_b")
}
...
func TestModuleTypeGlobalsPrefixed(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "@promise_typeinfo___mod_shapes_Circle")
	// std library types (e.g., int) should NOT have module prefix
	codegentest.AssertNotContains(t, ir, "__mod_shapes_int")
}
...
func TestModuleIRPrefixUsedForIR(t *testing.T) {
	...
	mod1Info, mod1Scope := codegentest.ParseModuleSource(t, "myalias", "helper() int `public { return 42; }")
	...
	codegentest.AssertContains(t, ir, "define i64 @__mod_github_com_alice_mylib_abc123_helper")
	codegentest.AssertNotContains(t, ir, "__mod_myalias_")
}

func TestCatalogModuleCallQualified(t *testing.T) {
	ir := codegentest.GenerateIRWithCatalogModule(t, "json",
	...
	codegentest.AssertContains(t, ir, "define i64 @__mod_json_parse")
	codegentest.AssertContains(t, ir, "call i64 @__mod_json_parse")
}
...
func TestCatalogModuleAliasedCall(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "define i64 @__mod_json_parse")
	codegentest.AssertContains(t, ir, "call i64 @__mod_json_parse")
	codegentest.AssertNotContains(t, ir, "__mod_j_")
}
...
func TestCatalogModuleTypeQualified(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "promise_typeinfo___mod_json_Value")
}
...
func TestUseVarDeclBasic(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "call void @Resource.close")
}
...
func TestUseVarDeclWithReturn(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "call void @Resource.close")
	codegentest.AssertContains(t, ir, "define i64 @__user.make_resource")
}
...
func TestCompileWithCacheNilEqualToCompile(t *testing.T) {
	...
	`)
	r1 := codegen.Compile(file, info, "")
	r2 := codegen.CompileWithCache(file, info, "", nil)
...
func TestCompileWithCacheSkipsInstanceBody(t *testing.T) {
	...
	rFull := codegen.Compile(file, info, "")
	fullIRs := rFull.InstanceIRs()
	if _, ok := fullIRs["Box[int]"]; !ok {
		t.Skipf("Box[int] not in InstanceIRs on full compile; keys: %v", codegentest.MapKeys(fullIRs))
	}

	// Cached compile: Box[int] body must be skipped → not in InstanceIRs.
	rCached := codegen.CompileWithCache(file, info, "", map[string]bool{"Box[int]": true})
...
func TestCompileWithCacheOnlySkipsCachedInstances(t *testing.T) {
	...
	if _, ok := cachedIRs["Box[string]"]; !ok {
		t.Errorf("Box[string] should appear in InstanceIRs (not cached); keys: %v", codegentest.MapKeys(cachedIRs))
	}
}
...
func TestModuleLevelGetterCodegen(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "define i64 @__user.answer()")
	// Usage should call the getter (no args)
	codegentest.AssertContains(t, ir, "call i64 @__user.answer()")
}
...
func TestModuleLevelSetterCodegen(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "define void @__user.counter$set(i64")
	// Assignment should call the setter
	codegentest.AssertContains(t, ir, "call void @__user.counter$set(i64")
}
...
func TestModuleLevelCompoundAssignCodegen(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "call i64 @__user.counter()")
	codegentest.AssertContains(t, ir, "call void @__user.counter$set(i64")
}
...
func TestModuleLevelGetterDistinctFromSetter(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "define i64 @__user.val()")
	codegentest.AssertContains(t, ir, "define void @__user.val$set(i64")
}
...
func TestModuleSplitStringConstantsPreserved(t *testing.T) {
	...
	result := codegentest.CompileResultWithModule(t, "mymod",
...
func TestModuleSplitNonPrivateGlobalsStripped(t *testing.T) {
	...
	result := codegentest.CompileResultWithModule(t, "shapes",
		`
		type Shape `+"`public"+` {
			string label;
...
func TestCrossModulePropagation(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "Map[string, int]")
}
...
func TestCrossModuleGenericMethodCallsGenericFunc(t *testing.T) {
	ir := codegentest.GenerateIRWithDependentModules(t,
		"helper",
	...
	codegentest.AssertContains(t, ir, `define i64 @"transform[int]"`)
	// The mono method apply[int] must be defined for Wrapper[string]
	codegentest.AssertContains(t, ir, `@"Wrapper[string].apply[int]"`)
}
...
func TestCrossModuleGenericMethodCallsGenericFuncMultipleInstances(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, `@"Box[int].unwrap[int]"`)
	codegentest.AssertContains(t, ir, `@"Box[string].unwrap[string]"`)
}
...
func TestT0436ModuleTypeBorrowedThisAfterOwnedDups(t *testing.T) {
	...
	getNFn := codegentest.ExtractFunction(ir, "__mod_t0436b_Holder2.get_n")
	if getNFn == "" {
