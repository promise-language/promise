...
func TestT0418_GenericTOptArgWrappedToTDoubleOpt(t *testing.T) {
	...
	`)
	body := codegentest.ExtractFunction(ir, `"_generic_double[_Box]"`)
	if body == "" {
...
func TestT0418_GenericOptionalArgNoSpuriousWrap(t *testing.T) {
	...
	body := codegentest.ExtractFunction(ir, `"_generic_passthrough[_Box]"`)
	if body == "" {
...
func TestT0418_GenericPrimitiveOptionalArg(t *testing.T) {
	...
	`)
	body := codegentest.ExtractFunction(ir, `"_generic_passthrough[int]"`)
	if body == "" {
