//go:build linux && arm64 && embed_stub
...
// installer can extract it (writeStubAndSidecar). Mirrors llvm_linux_arm64.go.
//
//go:embed resources/stub/linux-arm64/*
...
const stubEmbedPrefix = "resources/stub/linux-arm64"
