...
func TestAbstractReturnThisLoadsConcreteVtableFromInstance(t *testing.T) {
	...
	`)
	body := codegentest.ExtractDefine(ir, "SAddItem.dup")
	...
	codegentest.AssertNotContains(t, body, "promise_vtable_SAdd")
	codegentest.AssertContains(t, ir, "@promise_vtable_SAdd")
}
...
func TestNonAbstractBaseReturnThisLoadsInstanceVtable(t *testing.T) {
	...
	`)
	body := codegentest.ExtractDefine(ir, "Base.dup")
	codegentest.AssertContains(t, body, "heapdup")
	codegentest.AssertNotContains(t, body, "promise_vtable_Base")
}
...
func TestAbstractOperatorReturnThisLoadsInstanceVtable(t *testing.T) {
	...
	`)
	body := codegentest.ExtractFunction(ir, `"SAddItem.+"`)
	codegentest.AssertNotContains(t, body, "promise_vtable_SAdd")
}
...
func TestOwnedAbstractReturnThisDoesNotClone(t *testing.T) {
	...
	`)
	body := codegentest.ExtractDefine(ir, "SAddItem.consume")
