//go:build windows && amd64 && embed_stub
...
// installer can extract it (writeStubAndSidecar). Mirrors llvm_windows_amd64.go.
//
//go:embed resources/stub/windows-amd64/*
...
const stubEmbedPrefix = "resources/stub/windows-amd64"
