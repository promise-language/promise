...
func TestT0861OwnedStructuralParamDrop(t *testing.T) {
	...
	`)
	fn := codegentest.ExtractFunction(ir, "__user.sink")
	if fn == "" {
	...
	codegentest.AssertContains(t, fn, "struct.drop.call")
	codegentest.AssertContains(t, fn, "struct.drop.free")
}
...
func TestT0861BorrowStructuralParamNoDrop(t *testing.T) {
	...
	codegentest.AssertNotContains(t, fn, "struct.drop.call")
}
