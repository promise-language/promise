...
func TestT0660_BorrowedEnumReceiverNoReceiverDrop(t *testing.T) {
	...
	reg := codegentest.EnumReceiverTempRegister(body)
	if reg == "" {
	...
	if codegentest.EnumReceiverTempDropped(body, reg, "Tagged") {
...
func TestT0660_GenericOwnerBorrowedEnumReceiverNoReceiverDrop(t *testing.T) {
	...
	if codegentest.EnumReceiverTempDropped(body, reg, "GTag") {
