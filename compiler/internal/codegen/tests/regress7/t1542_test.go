...
func TestT1542ImportedValueTypeAsValueField(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, "%promise_Duration_v = type { i8*, i64 }")
	codegentest.AssertContains(t, ir, "%promise_W_v = type { i8*, %promise_Duration_v }")
}
...
func TestT1542ImportedValueTypeAsHeapField(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, "%promise_H_i = type { %promise_H_m*, %promise_Duration_v, i64 }")
}
...
func TestT1542ImportedValueTypeAsOptionalField(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, "%promise_Opt_i = type { %promise_Opt_m*, { i1, %promise_Duration_v } }")
}
...
func TestT1542ImportedValueTypeAsArrayField(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, "%promise_Arr_i = type { %promise_Arr_m*, [3 x %promise_Duration_v] }")
}
...
func TestT1542ImportedValueTypeAsTupleField(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, "%promise_Tup_i = type { %promise_Tup_m*, { %promise_Duration_v, i64 } }")
}
...
func TestT1542GenericUserTypeInstantiatedWithImportedValueType(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, `%"promise_Pair[Duration]_v" = type { i8*, %promise_Duration_v, %promise_Duration_v }`)
}
...
func TestT1542NestedValueTypeHoldingImportedValueType(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, "%promise_Inner_v = type { i8*, %promise_Duration_v }")
	codegentest.AssertContains(t, ir, "%promise_Outer_v = type { i8*, %promise_Inner_v }")
}
...
func TestT1542SameModuleValueFieldsUnaffected(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, `%"promise_Point[int]_v" = type { i8*, i64, i64 }`)
	codegentest.AssertContains(t, ir, `%promise_WithCoord_i = type { %promise_WithCoord_m*, %promise_Coord_v, %"promise_Point[int]_v" }`)
}
...
func TestT1542MonoValueFieldAlreadyLaidOutByEnumPrepass(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, `%"promise_Point[int]_v" = type { i8*, i64, i64 }`)
	codegentest.AssertContains(t, ir, `%promise_Holder_i = type { %promise_Holder_m*, %"promise_Point[int]_v" }`)
...
func TestT1542ModuleValueTypeAsField(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "%promise_Meters_v = type { i8*, i64 }")
	codegentest.AssertContains(t, ir, "%promise_Holder_v = type { i8*, %promise_Meters_v }")
}
...
func TestT1542ModuleNestedValueTypeAsField(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "%promise_Meters_v = type { i8*, i64 }")
	codegentest.AssertContains(t, ir, "%promise_Wrapped_v = type { i8*, %promise_Meters_v }")
	codegentest.AssertContains(t, ir, "%promise_Holder_i = type { %promise_Holder_m*, %promise_Wrapped_v, i64 }")
}
...
func TestT1542ModuleNestedValueTypeInLocalSignatureOnly(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "%promise_Meters_v = type { i8*, i64 }")
	codegentest.AssertContains(t, ir, "%promise_Wrapped_v = type { i8*, %promise_Meters_v }")
	codegentest.AssertNotContains(t, ir, "%promise_Wrapped_v = type { i8*, { i8*, i8* } }")
}
...
func TestT1542ModuleGenericValueTypeAsField(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, `%"promise_Boxed[int]_v" = type { i8*, i64 }`)
	codegentest.AssertContains(t, ir, `%promise_Holder_i = type { %promise_Holder_m*, %"promise_Boxed[int]_v" }`)
}
...
func TestT1542ModuleTypeWithStdValueField(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "%promise_Duration_v = type { i8*, i64 }")
	codegentest.AssertContains(t, ir, "%promise_Span_v = type { i8*, %promise_Duration_v }")
}
...
func TestT1542InheritedImportedValueField(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, "%promise_Base_i = type { %promise_Base_m*, %promise_Duration_v }")
	codegentest.AssertContains(t, ir, "%promise_Derived_i = type { %promise_Derived_m*, %promise_Duration_v, i64 }")
}
