...
func TestT0725_ThisIsVariantMethodMixedPayload(t *testing.T) {
	...
	`)
	body := codegentest.ExtractFunction(ir, "E.check_undef")
	if body == "" {
...
func TestT0725_ThisIsVariantGetter(t *testing.T) {
	...
	`)
	body := codegentest.ExtractFunction(ir, "E.is_undef")
	if body == "" {
...
func TestT0725_ThisIsVariantFieldlessEnum(t *testing.T) {
	...
	`)
	body := codegentest.ExtractFunction(ir, "F.is_a")
	if body == "" {
...
func TestT0725_IfThisIsVariantBind(t *testing.T) {
	...
	`)
	body := codegentest.ExtractFunction(ir, "E.unwrap")
	if body == "" {
