...
`)
	...
	codegentest.AssertContainsMatch(t, ir, `define i64 @"\.lambda\.ABox\[int\]\.\d+"`)
}
...
`)
	...
	codegentest.AssertContainsMatch(t, ir, `define i8\* @"\.lambda\.SBox\[string\]\.\d+"`)
	codegentest.AssertContainsMatch(t, ir, `define void @"\.lambda\.SBox\[string\]\.\d+\.env_drop"`)
}
...
`)
	codegentest.AssertContainsMatch(t, ir, `@"\.lambda\.VBox\[Vector\[int\]\]\.\d+"`)
	codegentest.AssertContainsMatch(t, ir, `define void @"\.lambda\.VBox\[Vector\[int\]\]\.\d+\.env_drop"`)
}
...
func TestT1254ModuleFunctionLambdaOwnerQualified(t *testing.T) {
	ir := codegentest.GenerateIRWithCatalogModule(t, "clomod",
	...
	codegentest.AssertContainsMatch(t, ir, `define i64 @\.lambda\.clomod\.\d+`)
}
...
func TestT1254ModuleFunctionEnvDropOwnerQualified(t *testing.T) {
	...
	codegentest.AssertContainsMatch(t, ir, `define i8\* @\.lambda\.clomod\.\d+`)
	codegentest.AssertContainsMatch(t, ir, `define void @\.lambda\.clomod\.\d+\.env_drop`)
}
