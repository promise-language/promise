...
func TestT0913ReassignEmitsEnvFree(t *testing.T) {
	...
	`)
	body := codegentest.FnBodyT0913(t, ir, "reassign_heap_t0913")
...
func TestT0913SelfAssignSingleEnvFree(t *testing.T) {
	...
	`)
	body := codegentest.FnBodyT0913(t, ir, "self_assign_t0913")
...
func TestT0913NonCapturingReassignNullGuard(t *testing.T) {
	...
	`)
	body := codegentest.FnBodyT0913(t, ir, "no_capture_reassign_t0913")
