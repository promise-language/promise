...
func TestT1190_BothNoneMatchLowersToI1(t *testing.T) {
	...
	`)
	body := codegentest.ExtractFunction(ir, "__user._both_none")
	if body == "" {
...
func TestT1190_BothNoneIfLowersToI1(t *testing.T) {
	...
	`)
	body := codegentest.ExtractFunction(ir, "__user._both_none_if")
	if body == "" {
...
func TestT1190_BothNoneGenericMonoLowersToI1(t *testing.T) {
	...
	body := codegentest.ExtractFunction(ir, `"_gen_both_none[int]"`)
	if body == "" {
