...
func TestT0906OptionalReturnThisHeap(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "define { i1, { i8*, i8* } } @OB.dup")
	// The optional wrap (present flag + value-struct payload) is emitted.
	codegentest.AssertContains(t, ir, "insertvalue { i1, { i8*, i8* } }")
...
func TestT0906OptionalReturnThisValueType(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "@VT.dup")
	codegentest.AssertContains(t, ir, "insertvalue { i1,")
}
...
func TestT0906OptionalReturnThisEnum(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "@OE.dup")
}
...
func TestT0906OptionalReturnThisEnumCloneMethod(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "@CE.dup")
	codegentest.AssertContains(t, ir, "enum.clone.tmp")
	codegentest.AssertContains(t, ir, "call %promise_CE_enum @CE.clone")
}
