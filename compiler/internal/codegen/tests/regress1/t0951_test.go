...
func TestT0951ArcInlineElvisHandleTracked(t *testing.T) {
	...
	codegentest.AssertContainsMatch(t, fn, codegentest.ElvisPathFlag)
	// The orphaned some-path handle is freed exactly once via the native Arc drop.
	codegentest.AssertContains(t, fn, `call void @"Ref[int].drop"`)
}
...
func TestT0951ChannelInlineElvisHandleTracked(t *testing.T) {
	...
	codegentest.AssertContainsMatch(t, fn, codegentest.ElvisPathFlag)
	codegentest.AssertContains(t, fn, `call void @"Channel[int].drop"`)
}
...
func TestT0951WeakInlineElvisHandleTracked(t *testing.T) {
	...
	codegentest.AssertContainsMatch(t, fn, codegentest.ElvisPathFlag)
	codegentest.AssertContains(t, fn, `call void @"Weak[int].drop"`)
}
...
func TestT0951MutexGuardInlineElvisHandleTracked(t *testing.T) {
	...
	codegentest.AssertContainsMatch(t, fn, codegentest.ElvisPathFlag)
	codegentest.AssertContains(t, fn, `call void @MutexGuard.drop`)
}
...
func TestT0951TaskInlineElvisHandleTracked(t *testing.T) {
	...
	codegentest.AssertContainsMatch(t, fn, codegentest.ElvisPathFlag)
	codegentest.AssertContains(t, fn, `call void @"Task[int].drop"`)
}
...
func TestT0951BorrowedHandleElvisNotTracked(t *testing.T) {
	...
	`)
	fn := codegentest.ExtractFunction(ir, "__user.borrowed_arc")
	if fn == "" {
		t.Fatal("could not extract __user.borrowed_arc")
	}
	codegentest.AssertNotContainsMatch(t, fn, codegentest.ElvisPathFlag)
...
func TestT0951GenericContextHandleElvisSubstituted(t *testing.T) {
	...
	fn := codegentest.ExtractDefine(ir, `"pick_chan[int]"`)
	if fn == "" {
...
func TestT0951MutexLockPromotionThreadsPerBranchFlag(t *testing.T) {
	...
	codegentest.AssertContains(t, fn, "strdrop.exec")
	codegentest.AssertContains(t, fn, `call void @"Mutex[int].drop"`)
	...
	codegentest.AssertContainsMatch(t, fn,
