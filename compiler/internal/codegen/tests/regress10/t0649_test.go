...
func TestT0649_RefMethodReturnNoStrdup(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		main() { caller(); }
	`)
	body := codegentest.ExtractFunction(ir, "RefRet.at")
	if body == "" {
		t.Fatalf("expected @RefRet.at in IR")
	}
	if n := codegentest.StringNewCount(body); n != 0 {
...
func TestT0649_OwnedControlStillStrdups(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		main() { caller(); }
	`)
	body := codegentest.ExtractFunction(ir, "OwnedRet.at")
	if body == "" {
		t.Fatalf("expected @OwnedRet.at in IR")
	}
	if codegentest.StringNewCount(body) == 0 {
...
func TestT0649_MutRefMethodReturnNoStrdup(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		main() { caller(); }
	`)
	body := codegentest.ExtractFunction(ir, "MutRet.at")
	if body == "" {
...
func TestT0649_UserIndexRefReturnNoStrdup(t *testing.T) {
	...
	body := codegentest.ExtractFunction(ir, `"IdxRef.[]"`)
	if body == "" {
...
func TestT0649_UserIndexOwnedControlStillStrdups(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		main() { caller(); }
	`)
	body := codegentest.ExtractFunction(ir, `"IdxOwn.[]"`)
	if body == "" {
...
func TestT0649_RefParamPassthroughNoStrdup(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		main() { caller(); }
	`)
	body := codegentest.ExtractFunction(ir, "__user.passthrough")
	if body == "" {
	...
	caller := codegentest.ExtractFunction(ir, "__user.caller")
...
func TestT0649_GenericRefMethodReturnNoStrdup(t *testing.T) {
	...
	body := codegentest.ExtractFunction(ir, `"GBox[string].at"`)
	if body == "" {
...
func TestT0649_EnumRefReturnNoClone(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		main() { caller(); }
	`)
	body := codegentest.ExtractFunction(ir, "EnumVecRef.at")
	if body == "" {
...
func TestT0649_EnumMutRefReturnNoClone(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		main() { caller(); }
	`)
	body := codegentest.ExtractFunction(ir, "EnumVecRef.at_mut")
	if body == "" {
...
func TestT0649_EnumOwnedControlStillClones(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		main() { caller(); }
	`)
	body := codegentest.ExtractFunction(ir, "EnumVecOwn.at")
	if body == "" {
...
func TestT0649_GenericEnumRefReturnNoClone(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		main() { caller(); }
	`)
	body := codegentest.ExtractFunction(ir, `"GBox[Tag].at"`)
	if body == "" {
