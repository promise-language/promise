...
func TestOperatorReturnVectorOperandDups(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, codegentest.ExtractFunction(ir, `"S.%"`), "vecdup")
}
...
func TestOperatorReturnChannelOperandDups(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, codegentest.ExtractFunction(ir, `"S.%"`), "chdup")
}
...
func TestOperatorReturnRefOperandDups(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, codegentest.ExtractFunction(ir, `"S.%"`), "arcdup")
}
...
func TestOperatorReturnWeakOperandDups(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		main() { }
	`)
	codegentest.AssertContains(t, codegentest.ExtractFunction(ir, `"S.%"`), "weakdup")
}
...
func TestOperatorReturnUserTypeOperandStillHeapDups(t *testing.T) {
	...
	`), `"S.%"`)
	codegentest.AssertContains(t, body, "heapdup")
	codegentest.AssertNotContains(t, body, "vecdup")
	codegentest.AssertNotContains(t, body, "chdup")
}
...
func TestOperatorReturnValueTypeOperandDoesNotDup(t *testing.T) {
	...
	`), `"S.%"`)
	codegentest.AssertNotContains(t, body, "vecdup")
	codegentest.AssertNotContains(t, body, "heapdup")
}
