...
func TestOperatorReturnOtherClonesBorrowedOperand(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, codegentest.ExtractFunction(ir, `"S.+"`), "heapdup")
}
...
func TestOperatorComparisonDoesNotClone(t *testing.T) {
	...
	`)
	codegentest.AssertNotContains(t, codegentest.ExtractFunction(ir, `"S.=="`), "heapdup")
}
...
func TestOperatorValueTypeOperandDoesNotClone(t *testing.T) {
	...
	`)
	codegentest.AssertNotContains(t, codegentest.ExtractFunction(ir, `"P.+"`), "heapdup")
}
...
func TestOperatorGenericReturnOtherClones(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, codegentest.ExtractFunction(ir, `"Box[int].+"`), "heapdup")
}
...
func TestOperatorNonDroppableEnumOperandDoesNotClone(t *testing.T) {
	...
	`)
	codegentest.AssertNotContains(t, codegentest.ExtractFunction(ir, `"S.+"`), "enumdup")
}
...
func TestOperatorDroppableEnumOperandClones(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, codegentest.ExtractFunction(ir, `"S.+"`), "enumdup")
}
