...
`)
	...
	codegentest.AssertContains(t, ir, "@Thing.tag$view_adapt_as_ViewA(")
	codegentest.AssertContains(t, ir, "@Thing.tag$view_adapt_as_ViewB(")
	// ...and the un-viewed colliding name is gone entirely.
	codegentest.AssertNotContains(t, ir, "@Thing.tag$view_adapt(")
...
`)
	...
	codegentest.AssertContains(t, ir, `@"GBox[string].tag$view_adapt_as_VA"`)
	codegentest.AssertContains(t, ir, `@"GBox[string].tag$view_adapt_as_VB"`)
