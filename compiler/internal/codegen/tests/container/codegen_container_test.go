...
func TestFunctionValueIndexCall(t *testing.T) {
	...
	codegentest.AssertNotContains(t, ir, "fns[int]")
	codegentest.AssertNotContains(t, ir, "undefined monomorphic")
...
func TestFunctionValueMemberFieldIndexCall(t *testing.T) {
	...
	codegentest.AssertNotContains(t, ir, "fns[int]")
	codegentest.AssertNotContains(t, ir, "no method")
...
func TestArrayLiteral(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "@.arr.0 = private constant")
	codegentest.AssertContains(t, ir, "[3 x i64] [i64 1, i64 2, i64 3]")
}

func TestArrayLiteralNonConstant(t *testing.T) {
	ir := codegentest.GenerateIR(t, `main() { int x = 1; int[] v = [x, x + 1]; }`)
...
func TestStaticVectorCOW(t *testing.T) {
	ir := codegentest.GenerateIR(t, `main() { x := [1, 2, 3]; x.push(4); }`)
	// Should call promise_vector_cow before push
	codegentest.AssertContains(t, ir, "call i8* @promise_vector_cow(")
...
func TestMapLiteral(t *testing.T) {
	ir := codegentest.GenerateIR(t, `main() { m := {"a": 1}; }`)
	// Should call monomorphized constructor and index assign
	codegentest.AssertContains(t, ir, "call void @\"Map[string, int].new\"(")
...
func TestMapIntKeys(t *testing.T) {
	ir := codegentest.GenerateIR(t, `main() { m := {1: "one", 2: "two"}; }`)
	// Should create monomorphized map with int keys
	codegentest.AssertContains(t, ir, "call void @\"Map[int, string].new\"(")
	codegentest.AssertContains(t, ir, `call void @"Map[int, string].[]="(`)
}
...
func TestSliceLen(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "getelementptr { i64, i64 }")
...
func TestFixedArrayLiteral(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "alloca [3 x i64]")
...
func TestFixedArrayIndex(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "arridx.oob")
	codegentest.AssertContains(t, ir, "call void @promise_panic(")
}
...
func TestFixedArrayLen(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "ret i64 3")
}
...
func TestFixedArrayCopy(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "alloca [3 x i64]")
	codegentest.AssertContains(t, ir, "store [3 x i64]")
	codegentest.AssertContains(t, ir, "load [3 x i64]")
}
...
func TestFixedArrayParam(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "[3 x i64]")
}
...
func TestFixedArrayFieldAssign(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "getelementptr [3 x i64]")
}
...
func TestFixedArrayFieldHeapUserElement(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "[2 x { i8*, i8* }]")
...
func TestFixedArrayFieldValueTypeElement(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "[2 x %promise__Pt_v]")
}
...
func TestFixedArrayF64(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, "alloca [2 x double]")
	codegentest.AssertContains(t, ir, "getelementptr [2 x double]")
}
...
func TestFixedArrayBool(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, "alloca [2 x i1]")
	codegentest.AssertContains(t, ir, "getelementptr [2 x i1]")
}
...
func TestMapLen(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "call i64 @\"Map[string, int].len\"(")
}
...
func TestSliceLenInCondition(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, "getelementptr { i64, i64 }")
	codegentest.AssertContains(t, ir, "icmp sgt i64")
}
...
func TestMapCompoundAssign(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, `call { i1, i64 } @"Map[string, int].[]"(`)
	codegentest.AssertContains(t, ir, "mapcomp.ok")
	codegentest.AssertContains(t, ir, "mapcomp.panic")
...
func TestIncDecIndexedElement(t *testing.T) {
	...
	`)
	// Should have bounds check
	codegentest.AssertContains(t, ir, "incdec.index.ok")
	codegentest.AssertContains(t, ir, "incdec.index.oob")
...
func TestVectorPush(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, "define i8* @promise_vector_push(")
	codegentest.AssertContains(t, ir, "call i8* @promise_vector_push(")
}
...
func TestVectorPop(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, "define i32 @promise_vector_pop(")
	codegentest.AssertContains(t, ir, "call i32 @promise_vector_pop(")
	codegentest.AssertContains(t, ir, "pop.some")
	codegentest.AssertContains(t, ir, "pop.none")
}
...
func TestVectorRemove(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, "define void @promise_vector_remove(")
	codegentest.AssertContains(t, ir, "call void @promise_vector_remove(")
}
...
func TestVectorContainsFuncBody(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "loop.header:")
	codegentest.AssertContains(t, ir, "loop.body:")
	codegentest.AssertContains(t, ir, "cmp_bytes:")
	codegentest.AssertContains(t, ir, "call_eq:")
	// memcmp replaces byte-by-byte loop
	codegentest.AssertContains(t, ir, "call i32 @memcmp(")
	codegentest.AssertNotContains(t, ir, "byte.header:")
	codegentest.AssertNotContains(t, ir, "byte.body:")
	codegentest.AssertContains(t, ir, "found:")
	codegentest.AssertContains(t, ir, "not_found:")
	codegentest.AssertContains(t, ir, "loop.next:")
}
...
func TestVectorRemoveFuncBody(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "panic:")
	codegentest.AssertContains(t, ir, "check_shift:")
	codegentest.AssertContains(t, ir, "do_shift:")
	codegentest.AssertContains(t, ir, "dec_len:")
	// Verify panic calls and memmove
	codegentest.AssertContains(t, ir, "call void @promise_panic(")
	codegentest.AssertContains(t, ir, "call void @llvm.memmove.p0i8.p0i8.i64(")
}
...
func TestVectorWithCapacityFuncBody(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "define i8* @promise_vector_with_capacity(")
	codegentest.AssertContains(t, ir, "call i8* @pal_alloc(")
	codegentest.AssertContains(t, ir, "init:")
...
func TestVectorPushFuncBody(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "define i8* @promise_vector_push(")
	codegentest.AssertContains(t, ir, "grow:")
	codegentest.AssertContains(t, ir, "call i8* @pal_realloc(")
	codegentest.AssertContains(t, ir, "oom:")
	codegentest.AssertContains(t, ir, "update_cap:")
	codegentest.AssertContains(t, ir, "copy:")
...
func TestVectorPopFuncBody(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "define i32 @promise_vector_pop(")
	codegentest.AssertContains(t, ir, "empty:")
	codegentest.AssertContains(t, ir, "do_pop:")
	codegentest.AssertContains(t, ir, "ret i32 0")
...
func TestVectorContainsIntNull(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "null)")
}
...
func TestVectorDefaultCapacity(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "call i8* @promise_vector_with_capacity(i64 16,")
}
...
func TestVectorExplicitCapacity(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "call i8* @promise_vector_with_capacity(i64 64,")
}
...
func TestSliceExprVector(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, `call i8* @"Vector[int].[:]"(`)
}
...
func TestSliceAssignVector(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, `call void @"Vector[int].[:]=`)
}
...
func TestUserDefinedIndexOperator(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, `call { i1, i64 } @"Grid.[]"(`)
}
...
func TestUserDefinedIndexAssignOperator(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, `call void @"Grid.[]="(`)
}
...
func TestUserDefinedSliceOperator(t *testing.T) {
	...
	`)
	codegentest.AssertContains(t, ir, `call i8* @"MyList.[:]"(`)
}
...
func TestT0735_MapLitReturnValueClaimed(t *testing.T) {
	...
	codegentest.AssertContains(t, body, "call i8* @pal_alloc(")
	codegentest.AssertContains(t, body, `call void @"Map[string, int].new"`)
	codegentest.AssertContains(t, body, "heap.claim")
	codegentest.AssertContains(t, body, "ret { i8*, i8* }")
}
...
func TestT0735_TwoMapLitsInSameStmtBothTracked(t *testing.T) {
	...
	codegentest.AssertContains(t, body, "call i64 @__user.borrow_a(")
	codegentest.AssertContains(t, body, "call i64 @__user.borrow_b(")
...
func TestT0745ThisIndexWriteNoExtractFromPtr(t *testing.T) {
	...
	`)
	codegentest.AssertNotContains(t, ir, "extractvalue i8*")
	setBare := codegentest.ExtractFunction(ir, "T0745WBox.set_bare")
	if setBare == "" {
		t.Fatal("expected T0745WBox.set_bare in IR")
	}
	codegentest.AssertContains(t, setBare, `@"T0745WBox.[]="(i8*`)
}
...
func TestT0745ThisSliceNoExtractFromPtr(t *testing.T) {
	...
	`)
	codegentest.AssertNotContains(t, ir, "extractvalue i8*")
	if codegentest.ExtractFunction(ir, "T0745SliceBox.head2") == "" {
		t.Fatal("expected T0745SliceBox.head2 in IR")
	}
	if codegentest.ExtractFunction(ir, "T0745SliceBox.replace01") == "" {
...
func TestT0745ThisIndexValueType(t *testing.T) {
	...
	`)
	codegentest.AssertNotContains(t, ir, "extractvalue i8*")
	if codegentest.ExtractFunction(ir, "T0745VPair.first") == "" {
