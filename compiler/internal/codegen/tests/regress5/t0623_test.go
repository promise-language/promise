...
func TestT0633_NestedUserTypeWrapperMoveOutIR(t *testing.T) {
	...
	dropBody := codegentest.ExtractFunction(ir, "Wrap.drop")
	if dropBody == "" {
...
func TestT0633_GenericWrapperMoveOutNullGuardIR(t *testing.T) {
	...
	dropBody := codegentest.ExtractFunction(ir, "GWrap.drop")
	if dropBody == "" {
...
func TestT0633_ArrayOfHandleMoveOutIR(t *testing.T) {
	...
	dropBody := codegentest.ExtractFunction(ir, "TA.drop")
	if dropBody == "" {
...
func TestT0633_PolymorphicWrapperMoveOutNullGuardIR(t *testing.T) {
	...
	dropBody := codegentest.ExtractFunction(ir, "PolyWrap.drop")
	if dropBody == "" {
...
func TestT0633_TupleHandleMoveOutMixedAggregateIR(t *testing.T) {
	...
	dropBody := codegentest.ExtractFunction(ir, "TupHold.drop")
	if dropBody == "" {
...
func TestT0675_EnumNestedInEnumMoveOutNullGuardIR(t *testing.T) {
	...
	outerDrop := codegentest.ExtractFunction(ir, "OuterHandle.drop")
	if outerDrop == "" {
	...
	innerDrop := codegentest.ExtractFunction(ir, "InnerHandle.drop")
	if innerDrop == "" {
