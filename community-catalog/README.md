...
compatibility (`docs/community-catalog.md`, module-system.md [Compatibility and the Community Catalog](../docs/module-system.md#compatibility-and-the-community-catalog)–[When a Module Has No Compatible Version](../docs/module-system.md#when-a-module-has-no-compatible-version)).
...
enabling its Actions is a one-time ops step (see [Ops standing up the repo](../docs/community-catalog.md#ops-standing-up-the-repo) of `docs/community-catalog.md`).
...
- `index/<epoch>.json` — the per-epoch compatibility index, written by CI: for
  ...
  no verified version for it ([When a Module Has No Compatible Version](../docs/module-system.md#when-a-module-has-no-compatible-version)).
...
- `.github/workflows/` — CI templates: `compat.yml` (per-epoch matrix build),
  `prerelease.yml` (the [When a Module Has No Compatible Version](../docs/module-system.md#when-a-module-has-no-compatible-version) pre-release nudge), and `check-epoch.yml` (a
