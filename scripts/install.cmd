...
:: from promise-lang.org. The install gate (T0803) invokes install.ps1 directly,
:: not this shim, so the override path is exercised there (T0804 removes it once public).
powershell -ExecutionPolicy Bypass -Command "irm https://promise-lang.org/install.ps1 | iex"
