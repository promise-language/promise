...
`)
	...
	codegentest.AssertContains(t, ir, `@"GBox[string].tag$view_adapt_as_Tagger"`)
	codegentest.AssertContains(t, ir, `@"GBox[int].tag$view_adapt_as_Tagger"`)
	// ...and the generic-named collision is gone entirely.
	codegentest.AssertNotContains(t, ir, "@GBox.tag$view_adapt")
