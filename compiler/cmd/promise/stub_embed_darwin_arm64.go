//go:build darwin && arm64 && embed_stub
...
// installer can extract it (writeStubAndSidecar). Mirrors llvm_darwin_arm64.go.
//
//go:embed resources/stub/darwin-arm64/*
...
const stubEmbedPrefix = "resources/stub/darwin-arm64"
