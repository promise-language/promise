...
func TestT1016ValueTypeAsEnumVariantField(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "%promise_Money_v = type { i8*, i64 }")
	...
	codegentest.AssertContains(t, ir, "{ %promise_Money_v }")
}
...
func TestT1016MultiFieldValueTypeAsEnumVariantField(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "%promise_Point3_v = type { i8*, i64, i64, i64 }")
	// Variant data struct embeds the full value struct.
	codegentest.AssertContains(t, ir, "{ %promise_Point3_v }")
}
...
func TestT1016GenericValueTypeAsEnumVariantField(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, `%"promise_Pair[int]_v" = type { i8*, i64, i64 }`)
...
func TestT1016NestedValueTypeAsEnumVariantField(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "%promise_Wallet_v = type { i8*, %promise_Money_v, i64 }")
	// Variant data struct embeds the outer value struct.
	codegentest.AssertContains(t, ir, "{ %promise_Wallet_v }")
}
