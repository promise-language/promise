...
func TestT1440_VectorIterClosureHasNoEnvDrop(t *testing.T) {
	...
	`)
	fn := codegentest.ExtractDefine(ir, "Vector[string].iter")
	if fn == "" {
		t.Fatalf("Vector[string].iter not found in IR")
	}
	codegentest.AssertNotContains(t, fn, "env_drop")
...
func TestT1440_VectorIntIterClosureHasNoEnvDrop(t *testing.T) {
	...
	`)
	fn := codegentest.ExtractDefine(ir, "Vector[int].iter")
	if fn == "" {
...
func TestT1440_MovedStringCaptureStillDropped(t *testing.T) {
	...
	`)
	envDrop := codegentest.FindEnvDropContaining(ir, "@promise_string_drop")
	if envDrop == "" {
...
func TestT1440_ForInCustomIterDropsStringElement(t *testing.T) {
	...
	`)
	fn := codegentest.ExtractDefine(ir, "__user.count")
	if fn == "" {
...
func TestT1440_ForInCustomIterDropsUserTypeElement(t *testing.T) {
	...
	codegentest.AssertContains(t, fn, "@T1440R.drop")
}
...
func TestT1440_ForInCustomIterDropsElementOnBreak(t *testing.T) {
	...
	`)
	fn := codegentest.ExtractDefine(ir, "__user.first")
	if fn == "" {
...
func TestT1440_ForInCustomIterIntElementNoDrop(t *testing.T) {
	...
	`)
	fn := codegentest.ExtractDefine(ir, "__user.total")
	if fn == "" {
...
func TestT1440_MovedVectorCaptureStillDropped(t *testing.T) {
	...
	`)
	envDrop := codegentest.FindEnvDropContaining(ir, "@Vector.drop")
	if envDrop == "" {
...
func TestT1440_MovedUserTypeCaptureStillDropped(t *testing.T) {
	...
	`)
	envDrop := codegentest.FindEnvDropContaining(ir, "@T1440C.drop")
	if envDrop == "" {
...
func TestT1440_UserTypeThisCaptureNotDropped(t *testing.T) {
	...
	`)
	if envDrop := codegentest.FindEnvDropContaining(ir, "@T1440O.drop"); envDrop != "" {
...
func TestT1440_ForInCustomIterDropsElementInGenericContext(t *testing.T) {
	...
	`)
	strFn := codegentest.ExtractDefine(ir, "gcount[string]")
	if strFn == "" {
		t.Fatalf("gcount[string] not found in IR")
	}
	codegentest.AssertContains(t, strFn, "@promise_string_drop")

	intFn := codegentest.ExtractDefine(ir, "gcount[int]")
	if intFn == "" {
		t.Fatalf("gcount[int] not found in IR")
	}
	codegentest.AssertNotContains(t, intFn, "@promise_string_drop")
}
...
func TestT1440_ForInCustomIterIndexedBindingDropsElement(t *testing.T) {
	...
	codegentest.AssertContains(t, fn, "@promise_string_drop")
	codegentest.AssertContains(t, fn, "iter.update")
}
