...
func TestFixedArrayReturnTempDiscardDropsElements(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "arrtmp.drop")
	codegentest.AssertContains(t, ir, "arrtmp.skip")
...
func TestFixedArrayReturnTempBoundClaimsTemp(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "arrdrop.exec")
	codegentest.AssertContains(t, ir, "call void @promise_string_drop")
}
...
func TestT1466IntArrayLiteralArgNoDrop(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		main() { take([1 + 2, 3 + 4]); }
	`)
	codegentest.AssertNotContains(t, ir, "arrtmp.drop")
}
...
func TestT1466GeneratorArrayLiteralArgScopeDrop(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "_genarrarg")
	codegentest.AssertContains(t, ir, "call void @promise_string_drop")
	codegentest.AssertNotContains(t, ir, "arrtmp.drop")
}
...
func TestT1466HeapUserArrayLiteralArgDropsElements(t *testing.T) {
	...
	codegentest.AssertContains(t, ir, "arrtmp.drop")
	codegentest.AssertContains(t, ir, "call void @Boxed.drop")
