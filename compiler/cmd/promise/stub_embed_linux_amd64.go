//go:build linux && amd64 && embed_stub
...
// installer can extract it (writeStubAndSidecar). Mirrors llvm_linux_amd64.go.
//
//go:embed resources/stub/linux-amd64/*
...
const stubEmbedPrefix = "resources/stub/linux-amd64"
