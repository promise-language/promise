...
func TestT0608_BareValueWrapsOptionalBeforeStore(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		main() {}
	`)
	body := codegentest.ExtractFunction(ir, "__user.mk_bare")
	if body == "" {
...
func TestT0608_NoneLiteralZeroInitBeforeStore(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		main() {}
	`)
	body := codegentest.ExtractFunction(ir, "__user.mk_none")
	if body == "" {
...
func TestT0608_ExplicitOptionalNoExtraWrap(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		main() {}
	`)
	body := codegentest.ExtractFunction(ir, "__user.mk_expl")
	if body == "" {
