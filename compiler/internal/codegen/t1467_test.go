...
`)
	body := t1467Body(t, ir)
	assertContains(t, body, "%_genarg")
	assertContains(t, body, "%_genarg.dropflag")
	assertContains(t, body, "strdrop.call")
	assertContains(t, body, "call void @promise_string_drop")
}
...
`)
	...
	assertContains(t, body, "@promise_string_concat")
	assertContains(t, body, "store i8* %")
}
...
`)
	body := t1467Body(t, ir)
	assertContains(t, body, "%_genarg")
	assertContains(t, body, "vecdrop.nonstatic")
	assertContains(t, body, "vecdrop.head")
	assertContains(t, body, "call void @Vector.drop")
}
...
`)
	body := t1467Body(t, ir)
	assertNotContains(t, body, "%_genarg")
...
`)
	body := t1467Body(t, ir)
	assertContains(t, body, "%_genheaparg")
	assertContains(t, body, "call void @pal_free")
}
...
`)
	...
	assertContains(t, body, "genheap.claim")
	assertContains(t, body, "genheap.claim.skip")
}
...
`)
	body := t1467Body(t, ir)
	assertContains(t, body, "%_genclosurearg")
	assertContains(t, body, "env.free")
	assertContains(t, body, "env.deep_drop")
}
...
`)
	body := t1467Body(t, ir)
	assertContains(t, body, "%_genenumarg")
	assertContains(t, body, "call void @Tag.drop")
}
...
`)
	body := t1467Body(t, ir)
	assertContains(t, body, "%_genenumarg = alloca i8*")
	assertContains(t, body, "call void @Tag.drop")
}
...
`)
	body := t1467Body(t, ir)
	assertNotContains(t, body, "%_genarg")
	assertNotContains(t, body, "%_genheaparg")
	assertNotContains(t, body, "%_genenumarg")
	assertNotContains(t, body, "%_genclosurearg")
}
...
`)
	body := extractDefine(ir, ".goroutine.0")
	if body == "" {
	...
	assertContains(t, strdrop, "taskjoin.wait")
	assertContains(t, strdrop, `call void @"Task[int].free_after_done"`)
}
...
`)
	body := t1467Body(t, ir)
	assertContains(t, body, "%_genarg")
	assertContains(t, body, `call void @"Channel[int].drop"`)
}
...
`)
	body := t1467Body(t, ir)
	assertContains(t, body, "%_genarg = alloca i8*")
	assertContains(t, body, "%_genarg.1 = alloca i8*")
}
...
`)
	body := t1467Body(t, ir)
	assertContains(t, body, "%_genarg = alloca i8*")
	assertNotContains(t, body, "%_genarg.1")
}
...
`
	...
	withContinue := strings.Count(t1467Body(t, generateIR(t, strings.Replace(src, "BODY", "continue;", 1))), dropSite)
	withoutContinue := strings.Count(t1467Body(t, generateIR(t, strings.Replace(src, "BODY", `acc = acc + "";`, 1))), dropSite)
	if withContinue == 0 {
