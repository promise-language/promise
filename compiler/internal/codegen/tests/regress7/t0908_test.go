...
func TestAssignFieldNoDropHeapUserEmitsDropOldPalFree(t *testing.T) {
	...
	`)
	mainFn := codegentest.ExtractDefine(ir, ".goroutine.main")
	codegentest.AssertContains(t, mainFn, "field.userdrop")
	codegentest.AssertContains(t, mainFn, "@pal_free")
}
...
func TestAssignIndexNoDropHeapUserEmitsDropOldPalFree(t *testing.T) {
	...
	`)
	mainFn := codegentest.ExtractDefine(ir, ".goroutine.main")
	codegentest.AssertContains(t, mainFn, "varfield.free")
	codegentest.AssertContains(t, mainFn, "@pal_free")
}
...
func TestAssignIndexNoDropHeapUserSlotToSlotDupsSource(t *testing.T) {
	...
	`)
	mainFn := codegentest.ExtractDefine(ir, ".goroutine.main")
	codegentest.AssertContains(t, mainFn, "heapdup.copy")
}
