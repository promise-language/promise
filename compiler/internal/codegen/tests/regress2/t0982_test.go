...
func TestT0982MutexReturnClearsDefaultFlag(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		demo() { make_mutex(9); }
	`)
	fn := codegentest.ExtractFunction(ir, "__user.make_mutex")
	if fn == "" {
		t.Fatal("could not extract __user.make_mutex")
	}
	none := codegentest.NoneBlockOf(t, fn)
...
func TestT0982ArcReturnClearsDefaultFlag(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		demo() { make_arc(9); }
	`)
	fn := codegentest.ExtractFunction(ir, "__user.make_arc")
	if fn == "" {
...
func TestT0982ChannelReturnClearsDefaultFlag(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		demo() { make_channel(); }
	`)
	fn := codegentest.ExtractFunction(ir, "__user.make_channel")
	if fn == "" {
...
func TestT0982HeapUserReturnClearsDefaultFlag(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		demo() { make_box(); }
	`)
	fn := codegentest.ExtractFunction(ir, "__user.make_box")
	if fn == "" {
...
func TestT0982MapReturnClearsDefaultFlag(t *testing.T) {
	ir := codegentest.GenerateIR(t, `
		...
		demo() { make_map(); }
	`)
	fn := codegentest.ExtractFunction(ir, "__user.make_map")
	if fn == "" {
