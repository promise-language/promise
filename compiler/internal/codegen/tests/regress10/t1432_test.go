...
func TestT1432_OptionalVectorMapGetterDups(t *testing.T) {
	...
	codegentest.AssertContains(t, fn, "vecdup")
}
...
func TestT1432_OptionalStringMapGetterDups(t *testing.T) {
	...
	`)
	fn := codegentest.ExtractDefine(ir, "Map[int, string?].[]")
	if fn == "" {
...
func TestT1432_OptionalRefMapGetterDups(t *testing.T) {
	...
	`)
	fn := codegentest.ExtractDefine(ir, "Map[int, Ref[int]?].[]")
	if fn == "" {
		t.Fatalf("Map[int, Ref[int]?].[] not found in IR")
	}
	codegentest.AssertContains(t, fn, "arcdup.inc")
}
...
func TestT1432_OptionalChannelMapGetterDups(t *testing.T) {
	...
	`)
	fn := codegentest.ExtractDefine(ir, "Map[int, Channel[int]?].[]")
	if fn == "" {
		t.Fatalf("Map[int, Channel[int]?].[] not found in IR")
	}
	codegentest.AssertContains(t, fn, "chdup.inc")
}
...
func TestT1432_OptionalWeakMapGetterDups(t *testing.T) {
	...
	`)
	fn := codegentest.ExtractDefine(ir, "Map[int, Weak[int]?].[]")
	if fn == "" {
		t.Fatalf("Map[int, Weak[int]?].[] not found in IR")
	}
	codegentest.AssertContains(t, fn, "weakdup.inc")
}
...
func TestT1432_OptionalIntMapGetterDoesNotDup(t *testing.T) {
	...
	`)
	fn := codegentest.ExtractDefine(ir, "Map[int, int?].[]")
	if fn == "" {
		t.Fatalf("Map[int, int?].[] not found in IR")
	}
	codegentest.AssertNotContains(t, fn, "strdup")
	codegentest.AssertNotContains(t, fn, "vecdup")
	codegentest.AssertNotContains(t, fn, "arcdup")
}
