...
func TestT0507_InheritedDropSynthesized(t *testing.T) {
	...
	body := codegentest.ExtractPlainDefinition(ir, "_T0507Box.drop")
	if body == "" {
	...
	holderBody := codegentest.ExtractPlainDefinition(ir, "_T0507Holder.drop")
	if holderBody == "" {
...
func TestT0507_InheritedDropGenericParent(t *testing.T) {
	...
	body := codegentest.ExtractPlainDefinition(ir, "_T0507NonGenChild.drop")
	if body == "" {
...
func TestT0507_InheritedDropChain(t *testing.T) {
	...
	cBody := codegentest.ExtractPlainDefinition(ir, "_T0507C.drop")
	if cBody == "" {
	...
	bBody := codegentest.ExtractPlainDefinition(ir, "_T0507B.drop")
	if bBody == "" {
...
func TestT0507_InheritedDropModule(t *testing.T) {
	ir := codegentest.GenerateIRWithModule(t, "modlib",
		`
	...
	body := codegentest.ExtractPlainDefinition(ir, "__mod_modlib__T0507ModBox.drop")
	if body == "" {
...
func TestT0507_NoSynthForOwnDrop(t *testing.T) {
	...
	body := codegentest.ExtractPlainDefinition(ir, "_T0507OwnChild.drop")
	if body == "" {
...
func TestT0507_NoSynthWhenNoInheritedDrop(t *testing.T) {
	...
	body := codegentest.ExtractPlainDefinition(ir, "_T0507Inheriting.drop")
	if body == "" {
